<html>
    ...
    <Form action="/ecwm604/index.php/option/updatePassword" method="GET">
            <table align="left" cellpadding="5">
                ...
                <tr>
                    <td><input type=text name="password" placeholder="New Password" size="25"></td>            
                    <td><input type=text name="confpassword" placeholder=" Confirm New Password" size="25"></td>                   
                </tr>
                <tr>
                    <td><input type=submit value="Change Password" style="width:150px;"></td>
                </tr>
            </table>
        </Form>
    </body>
